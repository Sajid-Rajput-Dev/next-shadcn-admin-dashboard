          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               <Badge 
                variant="secondary" 
                className={
                  politician.party === "Democrat" ? "bg-blue-500/10 text-blue-500 hover:bg-blue-500/20" :
                  politician.party === "Republican" ? "bg-red-500/10 text-red-500 hover:bg-red-500/20" :
                  "bg-gray-500/10 text-gray-500"
                }
              >
                {politician.party}
              </Badge>
              <span className="text-xs text-muted-foreground">{politician.state}</span>
            </div>
          </div>
        </div>
